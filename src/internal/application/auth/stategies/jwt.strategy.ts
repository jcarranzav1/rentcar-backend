...
import { omitPassword as omitOwnerPassword } from 'src/internal/domain/dto/owner.response'
import { JWTPayload } from 'src/internal/domain/dto/token'
import { omitPassword as omitUserPassword } from 'src/internal/domain/dto/user.response'
